...
import {
  circleMarkerProps as propDefs,
  circleMarkerPropSetters as propSetters,
  filterLeafletProps,
...
export default defineComponent({
  ...
  setup(props, { attrs, expose }) {
    ...
    let map: L.Map;
    let leafletObject: L.CircleMarker;
    ...
    const _setup = (map: L.Map) => {
      leafletObject = L.circleMarker(props.latLng, filterLeafletProps(props, propDefs))
        .addTo(map);
